"""
Standalone tests for inference endpoints (/v1/messages/inference).
Uses a minimal FastAPI app without database dependencies.
Mocks LM Studio API responses.
"""
...
# =====================================================================
# TESTS: INFERENCE SERVICE UNIT TESTS
# =====================================================================
...
class TestInferenceService:
    ...
    async def test_generate_response_with_history(self):
        ...
        mock_response.json.return_value = {
            "model": "local-model",
            "choices": [{
                "message": {"content": "Context-aware response"},
                "finish_reason": "stop"
            }],
            "usage": {}
        }
